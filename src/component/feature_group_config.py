...
FEATURE_GROUP_NAME = 'bangalore_electricity_demand_fg'
FEATURE_GROUP_VERSION = 3
FEATURE_GROUP_METADATA = FeatureGroupConfig(
    name='bangalore_electricity_demand_fg',
    version=3,
    description='Feature group with hourly time-series data of historical demand values for Bangalore & Karnataka regions',
...
FEATURE_VIEW_NAME = 'bangalore_electricity_demand_fv'
FEATURE_VIEW_VERSION = 3
FEATURE_VIEW_METADATA = FeatureViewConfig(
    name='bangalore_electricity_demand_fv',
    version=3,
    feature_group=FEATURE_GROUP_METADATA,
)

MODEL_NAME = 'bangalore_demand_predictor_next_hour'
MODEL_VERSION=2
...
FEATURE_GROUP_MODEL_PREDICTIONS = 'bangalore_predictions_fg'
FEATURE_GROUP_PREDICTIONS_METADATA = FeatureGroupConfig(
    name='bangalore_predictions_fg',
    version=1,
    description='Predictions generated by Bangalore demand forecasting model',
    primary_key=['sub_region_code', 'date'],
    event_time='date',
)

# TODO remove FEATURE_VIEW_MODEL_PREDICTIONS and use FEATURE_VIEW_PREDICTIONS_METADATA instead
FEATURE_VIEW_MODEL_PREDICTIONS = 'bangalore_predictions_fv'
FEATURE_VIEW_PREDICTIONS_METADATA = FeatureViewConfig(
    name='bangalore_predictions_fv',
    version=3,
